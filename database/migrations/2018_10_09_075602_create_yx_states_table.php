...
class CreateYxStatesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('yx_states', function (Blueprint $table) {
            ...
            $table->integer('max_pf_half_team')->default(1200)->comment('成功报名组数');
            $table->integer('max_pf_full_team')->default(1200)->comment('成功报名组数');
            $table->integer('max_zh_full_team')->default(1200)->comment('成功报名组数');
